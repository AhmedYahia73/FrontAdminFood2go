...
const EditCategoryPage = () => {
  ...
  const {
    ...
    data: dataCategory,
  } = useGet({ url: `${apiUrl}/admin/category/item/${categoryId}` });
  const { postData, loadingPost, response } = usePost({
    url: `${apiUrl}/admin/category/update/${categoryId}`,
  });
    ...
    if (dataTranslation && dataCategories) {
      ...
      setCategoriesParent(
        [
          ...
          ...dataCategories.parent_categories,
        ] || []
      );
  ...
  useEffect(() => {
    if (dataCategory && dataCategory.category_names && dataCategory.category) {
      ...
      setStateCategoriesParent(
        dataCategory?.category?.parent?.name || stateCategoriesParent
      );
      ...
      setModuleCategory(dataCategory.category.module || "all");
    }
  }, [dataCategory]);
