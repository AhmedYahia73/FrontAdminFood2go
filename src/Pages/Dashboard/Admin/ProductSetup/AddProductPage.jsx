      ...
      {loadingTranslation ||
        ...
        >
          <div className="flex flex-col items-start justify-start w-full gap-5">
            ...
            <div className="flex flex-col items-start justify-start w-full gap-3 p-5 bg-white border border-gray-200 shadow-sm rounded-2xl">
              <span className="text-xl font-TextFontSemiBold text-thirdColor">
                {t("ProductType")}:
              </span>
              <div className="flex flex-wrap items-center gap-4">
                <button
                  ...
                  className={`flex items-center gap-3 px-6 py-3 rounded-xl font-TextFontMedium text-base transition-all duration-200 cursor-pointer ${
                    productType === "food"
                      ? "bg-mainColor text-white shadow-md shadow-mainColor/25 scale-[1.02]"
                      : "bg-gray-100 text-gray-600 hover:bg-gray-200"
                  }`}
                >
                  <span className="text-xl">🍔</span>
                  <span>{t("FoodProduct")}</span>
                </button>
                <button
                  type="button"
                  onClick={() => setProductType("time")}
                  className={`flex items-center gap-3 px-6 py-3 rounded-xl font-TextFontMedium text-base transition-all duration-200 cursor-pointer ${
                    productType === "time"
                      ? "bg-mainColor text-white shadow-md shadow-mainColor/25 scale-[1.02]"
                      : "bg-gray-100 text-gray-600 hover:bg-gray-200"
